...
model_name="GINE_maxpool_SingleModel" fingerprints_path="results/ids_to_fingerprint_GINE_AdmetFiltered_maxpool_10M.pt"

python sweep_no_ens.py --model-name "$model_name" --fingerprints-path "$fingerprints_path"
